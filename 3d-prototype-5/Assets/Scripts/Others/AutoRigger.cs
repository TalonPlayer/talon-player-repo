...
public class AutoRigger : EditorWindow
{
    ...
    {
        new BoneEntry("Pelvis",        "Root|Pelvis|Hips"),
        new BoneEntry("Left Hips",     "Leg.L|Thigh.L"),
        new BoneEntry("Left Knee",     "Knee.L"),
        new BoneEntry("Left Foot",     "Foot.L|Ankle.L"),
        new BoneEntry("Right Hips",    "Leg.R|Thigh.R"),
        new BoneEntry("Right Knee",    "Knee.R"),
        new BoneEntry("Right Foot",    "Foot.R|Ankle.R"),
        new BoneEntry("Left Arm",      "Arm.L|UpperArm.L|Shoulder.L"),
        new BoneEntry("Left Elbow",    "Elbow.L|ForeArm.L"),
        new BoneEntry("Left Wrist",    "Wrist.L|Hand.L"),     // <-- added
        new BoneEntry("Right Arm",     "Arm.R|UpperArm.R|Shoulder.R"),
        new BoneEntry("Right Elbow",   "Elbow.R|ForeArm.R"),
        new BoneEntry("Right Wrist",   "Wrist.R|Hand.R"),     // <-- added
        new BoneEntry("Middle Spine",  "Spine.02|Spine2|Spine"),
